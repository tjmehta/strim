...
module.exports = function () {
  ...
  function write (chunk) {
     ...
     * 1. Both this and the last parsed chunk were at least 1 line and length > 0,
     *    must separate with \n
    ...
    this.queue(parsedChunkString.replace(/\r/g, ''));
  }
  function end () {
    if (atLeastOneLine && !lastParsedChunk && lastChunkLastLine) {
      this.queue(('\n' + lastChunkLastLine).replace(/\r/g, ''));
    }
    this.queue(null);
  }
